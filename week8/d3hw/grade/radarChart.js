...
function RadarChart(id, data, options) {
	...
	var cfg = {
	 ...
	 maxValue: 0, 				//What is the grade that the biggest circle will represent
	...
	var allAxis = (data[0].map(function(i, j){return i.subject})),	//Names of each axis
	...
	var radarLine = d3.svg.line.radial()
		...
		.radius(function(d) { return rScale(d.grade); })
	...
	blobWrapper.selectAll(".radarCircle")
		...
		.attr("cx", function(d,i){ return rScale(d.grade) * Math.cos(angleSlice*i - Math.PI/2); })
		.attr("cy", function(d,i){ return rScale(d.grade) * Math.sin(angleSlice*i - Math.PI/2); })
